...
<head>
    ...
    <link rel="stylesheet" href="css/video-controls.css" type="text/css">
</head>
...
<body>
    <div class="container">
        <div class="video-container" id="video-container">
            ...
            <video controls class="video" id="video" preload="metadata" poster="video/poster.jpg">
                <source src="video/video.mp4" type="video/mp4">
                </source>
            </video>

            <div class="hidden video-controls" id="video-controls">
